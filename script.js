...
const questions = [
  ...
  {
    topic: "美國就業",
    question: "美國新增就業高於預期，但薪資成長放慢。最合理的解讀是？",
    options: [
      "就業與薪資都正在快速升溫",
      "就業市場仍然穩定，但薪資上漲速度正在放慢",
      "就業市場已經進入衰退",
      "薪資放慢代表企業正在大量裁員"
    ],
    correct: 1,
    explanation: "新增就業高於預期，表示企業仍有招募需求；薪資成長放慢，則代表薪資持續推高物價的風險稍微降低。",
    source: SOURCE_WEEKLY,
    sourceLabel: "MacroMicro 9/6 一週盤前"
  },
  {
    topic: "政策判讀",
    question: "為什麼就業數據公布後，市場仍然關注美國消費者物價指數（CPI）？",
    options: [
      "因為 CPI 是聯準會判斷利率的重要依據",
      "因為 CPI 可以直接預測企業獲利",
      "因為 CPI 主要用來計算新增就業",
      "因為 CPI 會決定政府的發債規模"
    ],
    correct: 0,
    explanation: "聯準會制定利率時，會同時觀察就業與通膨。當就業市場仍然穩定，如果 CPI 高於預期，利率可能維持高檔更久；如果 CPI 降溫，聯準會就有更多空間採取較寬鬆的政策。",
    source: SOURCE_WEEKLY,
    sourceLabel: "MacroMicro 9/6 一週盤前"
  },
  {
